...
% \name is self-explanatory. \topinfo is for things like social media, email, phone number, address, etc.
  \name{David}{Chen} & \begin{minipage}{0.4\textwidth}
    \vspace{6pt}
    \href{mailto:dychen@college.harvard.edu}{dychen@college.harvard.edu}  \\
...
\begin{minipage}[t]{0.7\textwidth}
  ...
  \textbf{WikiWhere} \hfill \href{https://wikiwhere.rciliberto.com/}{\faLink \, \textit{https://wikiwhere.rciliberto.com/}} \quad \href{https://github.com/wikiwhere/wikiwhere}{\faGithub \, \textit{wikiwhere/wikiwhere}} \newline
